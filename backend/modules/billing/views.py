...
import stripe
from api.audit_log import AuditEvent
...
_log_audit_event_resolver: Callable[[], Callable[..., Any]] | None = None


def register_log_audit_event_resolver(resolver: Callable[[], Callable[..., Any]]) -> None:
    """Allow shims/tests to override the audit logger used by billing views."""

    global _log_audit_event_resolver
    _log_audit_event_resolver = resolver


def _emit_log_audit_event(*args, **kwargs):
    handler = _log_audit_event_resolver() if _log_audit_event_resolver else _default_log_audit_event
